...
export async function s3GetNotificationConfiguration(id: string): Promise<S3NotificationConfiguration> {
  return await invoke<S3NotificationConfiguration>('s3_get_notification_configuration', { id });
}
