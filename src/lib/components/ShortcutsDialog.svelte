      ...
      groups: [
        {
          ...
          shortcuts: [
            ...
            { keys: `${platform.alt}\u2190 / ${platform.alt}\u2192`, desc: 'History back / forward' },
          ],
        },
        {
          title: 'Selection',
          shortcuts: [
            ...
            { keys: `${platform.mod}${platform.shift}P`, desc: 'Command palette' },
          ],
        },
      ],
    },
      ...
      groups: [
        {
          ...
          shortcuts: [
            ...
            { keys: `${platform.mod}Z`, desc: 'Undo last operation' },
